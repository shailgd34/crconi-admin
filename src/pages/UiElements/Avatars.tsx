...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="Crconi digital  Avatars Dashboard | Crconi Digital Admin - Crconi digital  Admin Dashboard Template"
        description="This is Crconi digital  Avatars Dashboard page for Crconi Digital Admin - Crconi digital  Tailwind CSS Admin Dashboard Template"
      />
