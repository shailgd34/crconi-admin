...
export default function Badges() {
  return (
    <div>
      <PageMeta
        title="Crconi digital  Badges Dashboard | Crconi Digital Admin - Crconi digital  Admin Dashboard Template"
        description="This is Crconi digital  Badges Dashboard page for Crconi Digital Admin - Crconi digital  Tailwind CSS Admin Dashboard Template"
      />
